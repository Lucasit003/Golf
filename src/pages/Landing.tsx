...
const STEPS = [
  {
    n: '01',
    title: 'Film',
    body: 'On your phone — down-the-line and face-on. Full body in frame, feet to hands.',
    icon: (
      <>
        ...
        <div className="hero__inner">
          <div className="hero__copy">
            ...
            <p className="hero__lede">
              Setjis Swing tracks your body through the swing, measures it against tour
        ...
        <div className="measures__grid">
          ...
          <div className="measures__list">
            ...
            <p className="measures__caveat">
              ...
              Setjis Swing measures the body, and says so instead of faking the rest.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section reference">
        <div className="reference__grid">
          ...
          <Reveal className="reference__copy" delay={120}>
            ...
            <p className="section__lede">
              Other apps hand you a number. Setjis Swing draws the tour move as a ghost over
